<?php
/*
 * Template Name: Trang doan truong cao dang hermann-gmeiner
 */
?>
<?php get_header(); ?>
</div>
...
<h1>ĐOÀN TRƯỜNG CAO ĐẲNG HERMANN GMEINER</h1>
    <?php
    $v_args = array(
        'cat' => 88,
        'post_type' => 'post',
    ...
    for ($i = 1; $i <= $pagedPost; $i ++) {
        if ((int) $paged == $i) {
            echo "<li><a href='http://doanso.abc/doan-truong-cao-dang-hermann-gmeiner/page/" . $i . "' class='active'>" . $i . "</a></li>";
        } else {
            echo "<li><a href='http://doanso.abc/doan-truong-cao-dang-hermann-gmeiner/page/" . $i . "'>" . $i . "</a></li>";
        }
    }
    echo "</ul>";
    ?>
