<?php
/*
 * Template Name: Trang truong cao dang nghe thanh pho
 */
?>
<?php get_header(); ?>
</div>
...
<h1>ĐOÀN TRƯỜNG CAO ĐẲNG NGHỀ THÀNH PHỐ</h1>
    <?php
    $v_args = array(
        'cat' => 87,
        'post_type' => 'post',
    ...
    for ($i = 1; $i <= $pagedPost; $i ++) {
        if ((int) $paged == $i) {
            echo "<li><a href='http://doanso.abc/doan-truong-cao-dang-nghe-thanh-pho/page/" . $i . "' class='active'>" . $i . "</a></li>";
        } else {
            echo "<li><a href='http://doanso.abc/doan-truong-cao-dang-nghe-thanh-pho/page/" . $i . "'>" . $i . "</a></li>";
        }
    }
    echo "</ul>";
    ?>
