<?php
/*
 * Template Name: Trang hoc tap theo bac nhung tam guong tieu bieu
 */
?>
<?php get_header(); ?>
</div>
...
<h1>HỌC TẬP VÀ LÀM THEO BÁC - NHỮNG TẤM GƯƠNG TIÊU BIỂU</h1>
    <?php
    $v_args = array(
        'cat' => 82,
        'post_type' => 'post',
    ...
    for ($i = 1; $i <= $pagedPost; $i ++) {
        if ((int) $paged == $i) {
            echo "<li><a href='http://doanso.abc/hoc-tap-va-lam-theo-bac-nhung-tam-guong-tieu-bieu/page/" . $i . "' class='active'>" . $i . "</a></li>";
        } else {
            echo "<li><a href='http://doanso.abc/hoc-tap-va-lam-theo-bac-nhung-tam-guong-tieu-bieu/page/" . $i . "'>" . $i . "</a></li>";
        }
    }
    echo "</ul>";
    ?>
