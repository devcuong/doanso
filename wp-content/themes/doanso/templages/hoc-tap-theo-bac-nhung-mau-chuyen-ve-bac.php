<?php
/*
 * Template Name: Trang hoc tap theo bac nhung mau chuyen ve bac
 */
?>
<?php get_header(); ?>
</div>
...
<h1>HỌC TẬP VÀ LÀM THEO BÁC - NHỮNG MẪU CHUYỆN VỀ BÁC</h1>
    <?php
    $v_args = array(
        'cat' => 81,
        'post_type' => 'post',
    ...
    for ($i = 1; $i <= $pagedPost; $i ++) {
        if ((int) $paged == $i) {
            echo "<li><a href='http://doanso.abc/hoc-tap-va-lam-theo-bac-nhung-mau-chuyen-ve-bac/page/" . $i . "' class='active'>" . $i . "</a></li>";
        } else {
            echo "<li><a href='http://doanso.abc/hoc-tap-va-lam-theo-bac-nhung-mau-chuyen-ve-bac/page/" . $i . "'>" . $i . "</a></li>";
        }
    }
    echo "</ul>";
    ?>
